...
class AirCargoProblem(Problem):
    ...
    def get_actions(self):
        ...
        def load_actions():
            ...
            # 5/10/17 Bhinesh Patel - Used fly_actions to figure this out.
    ...
    def actions(self, state: str) -> list:
        ...
        """
        # TODO implement
        # 5/10/17 Bhinesh Patel - Straight copy from example_have_cake.py
        possible_actions = []
    ...
    def h_ignore_preconditions(self, node: Node):
        ...
        # 5/10/17 Bhinesh Patel - Modified goal_test to return count how many not reached goal. That must be the minimum actions left.
        # Got this from a forum posting but I can't remember now.
        count = 0
        kb = PropKB()
